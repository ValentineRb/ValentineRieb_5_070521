...
function validateForm(firstNameField, lastNameField, emailField, addressField, cityField) {
  ...
  const isValidForm = validateField(firstNameField, onlyTextRegex) && validateField(lastNameField, onlyTextRegex) && validateField(emailField, emailRegex) && validateField(addressField, alphanumericTextRegex) && validateField(cityField, onlyTextRegex);
  return isValidForm;
}
